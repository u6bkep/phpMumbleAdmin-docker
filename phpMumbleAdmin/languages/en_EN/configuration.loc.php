...
$TEXT['conn_login_info'] = 'This option let you choose the login name you want to connect to servers with phpMumbleAdmin HTTP links.';
...
$TEXT['default_locales'] = 'Default system locales';
$TEXT['add_locales_profile'] = 'Add a system locales profile';
$TEXT['del_locales_profile'] = 'Delete a system locales profile';
...
$TEXT['IcePhp_include_path'] = 'Path for Ice.php file';

$TEXT['allowOfflineAuth'] = 'Authorize authentication when the server is offline';
$TEXT['allowOfflineAuth_info'] = 'To authenticate a mumble user, the virtual server must be online. This option authorize PMA to start the server for authentication, then stop it.';
...
$TEXT['see_external_viewer'] = 'Display external viewer';
