...
$TEXT['conn_login_info'] = 'Cette option vous permet de choisir le pseudo avec lequel vous voulez vous connecter aux serveurs via les liens HTTP de phpMumbleAdmin.';
...
$TEXT['default_locales'] = 'Locales du système par défaut';
$TEXT['add_locales_profile'] = 'Ajouter un profile de locales système';
$TEXT['del_locales_profile'] = 'Supprimer un profile de locales système';
...
// Subtabs settings
$TEXT['subtab_general'] = 'Général';
$TEXT['subtab_mumbleUsers'] = 'Comptes mumble';
$TEXT['subtab_autoban'] = 'Autoban';
$TEXT['subtab_logs'] = 'Logs';
$TEXT['subtab_tables'] = 'Tables';
$TEXT['subtab_smtp'] = 'Serveur smtp';
$TEXT['subtab_extViewer'] = 'Viewer externe';
...
$TEXT['IcePhp_include_path'] = 'Chemin du fichier Ice.php';

$TEXT['allowOfflineAuth'] = 'Autoriser l\'authentification quand le serveur est arrêté';
$TEXT['allowOfflineAuth_info'] = 'Pour authentifier les utilisateurs mumble, le serveur virtuel doit être en ligne. Cet option permet à PMA de démarrer le serveur pour l\'authentification, puis l\'arrêter.';
...
$TEXT['see_external_viewer'] = 'Afficher le viewer externe';
