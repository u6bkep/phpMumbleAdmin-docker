...
if (isset($page->vserverName)) {

    $widget->displayServerName = true;

    $widget->set('serverID', $page->vserverID);
    $widget->set('serverName', $page->vserverName);
    $widget->infoPanelSrc = $PMA->cookie->get('infoPanel') ? PMA_IMG_TOGGLE_OUT_16 : PMA_IMG_TOGGLE_IN_16;
}
