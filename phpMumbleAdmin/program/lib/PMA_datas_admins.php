...
class PMA_datas_admins extends PMA_datas
{
    ...
    /*
    * Table of custom existing login name.
    * This is usefull to add SuperAdmin login for example.
    */
    protected $customExistingLogin = array();
    ...
    */
    ...
    /*
    * Add a login to the customExistingLogin table.
    *
    * @return null
    */
    public function addCustomLogin($login)
    {
        $this->customExistingLogin[] = $login;
    }
    ...
    */
    public function loginExists($login)
    {
        ...
        foreach ($this->customExistingLogin as $custom) {
            if ($login === strToLower($custom)) {
                return true;
            }
        }
        // Check all admins
