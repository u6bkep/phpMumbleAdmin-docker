...
class PMA_datesHelper
{
    ...
    */
    public static function datetimeToTimestamp($str)
    {
        ...
        $regex2 =  '/^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}$/';
        // ie: 2012-04-07
        $regex3 =  '/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/';
        /*
        * Transformation into a valid $regex1.
        */
        if (preg_match($regex2, $str) === 1) {
            $str = str_replace('T', ' ', $str);
        } elseif (preg_match($regex3, $str) === 1) {
            $str .= ' 00:00:00';
        }
        /*
        * Transformation into timestamp.
        */
        if (preg_match($regex1, $str) === 1) {
