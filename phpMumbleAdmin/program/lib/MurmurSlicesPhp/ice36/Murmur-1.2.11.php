...
if(!class_exists('Murmur_TextMessage'))
{
    class Murmur_TextMessage
    {
    ...
    $Murmur__t_TextMessage = IcePHP_defineStruct('::Murmur::TextMessage', 'Murmur_TextMessage', array(
...
global $Murmur__t_TreePrx;
if(!isset($Murmur__t_Tree))
{
    $Murmur__t_Tree = IcePHP_declareClass('::Murmur::Tree');
    $Murmur__t_TreePrx = IcePHP_declareProxy('::Murmur::Tree');
}
...
if(!class_exists('Murmur_Tree'))
{
    ...
    $Murmur__t_Tree = IcePHP_defineClass('::Murmur::Tree', 'Murmur_Tree', -1, false, false, $Ice__t_Object, null, array(
...
if(!class_exists('Murmur_NestingLimitException'))
{
    class Murmur_NestingLimitException extends Murmur_MurmurException
    {
        public function __construct()
        {
            parent::__construct();
...
{
    interface Murmur_ServerCallback extends Ice_Object
    {
    ...
    IcePHP_defineOperation($Murmur__t_ServerCallback, 'userTextMessage', 2, 2, 0, array(array($Murmur__t_User, false, 0), array($Murmur__t_TextMessage, false, 0)), null, null, null);
...
{
    interface Murmur_ServerContextCallback extends Ice_Object
    {
    ...
    $Murmur__t_ServerContextCallback = IcePHP_defineClass('::Murmur::ServerContextCallback', 'Murmur_ServerContextCallback', -1, true, false, $Ice__t_Object, null, null);

    $Murmur__t_ServerContextCallbackPrx = IcePHP_defineProxy($Murmur__t_ServerContextCallback);

    IcePHP_defineOperation($Murmur__t_ServerContextCallback, 'contextAction', 2, 2, 0, array(array($IcePHP__t_string, false, 0), array($Murmur__t_User, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0)), null, null, null);
}
...
{
    interface Murmur_ServerAuthenticator extends Ice_Object
    {
    ...
    IcePHP_defineOperation($Murmur__t_ServerAuthenticator, 'authenticate', 2, 2, 0, array(array($IcePHP__t_string, false, 0), array($IcePHP__t_string, false, 0), array($Murmur__t_CertificateList, false, 0), array($IcePHP__t_string, false, 0), array($IcePHP__t_bool, false, 0)), array(array($IcePHP__t_string, false, 0), array($Murmur__t_GroupNameList, false, 0)), array($IcePHP__t_int, false, 0), null);
...
{
    interface Murmur_Server extends Ice_Object
    {
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'getCertificateList', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), null, array($Murmur__t_CertificateList, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'getTree', 2, 2, 0, null, null, array($Murmur__t_Tree, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'getBans', 2, 2, 0, null, null, array($Murmur__t_BanList, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'setBans', 2, 2, 0, array(array($Murmur__t_BanList, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'kickUser', 0, 0, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException, $Murmur__t_InvalidSecretException));
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'sendMessage', 0, 0, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException, $Murmur__t_InvalidSecretException));
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'addContextCallback', 0, 0, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0), array($IcePHP__t_string, false, 0), array($Murmur__t_ServerContextCallbackPrx, false, 0), array($IcePHP__t_int, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidCallbackException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'removeContextCallback', 0, 0, 0, array(array($Murmur__t_ServerContextCallbackPrx, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidCallbackException, $Murmur__t_InvalidSecretException));
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'setChannelState', 2, 2, 0, array(array($Murmur__t_Channel, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException, $Murmur__t_NestingLimitException));
    ...
    IcePHP_defineOperation($Murmur__t_Server, 'addChannel', 0, 0, 0, array(array($IcePHP__t_string, false, 0), array($IcePHP__t_int, false, 0)), null, array($IcePHP__t_int, false, 0), array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException, $Murmur__t_NestingLimitException));
    IcePHP_defineOperation($Murmur__t_Server, 'sendMessageChannel', 0, 0, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_bool, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'getACL', 2, 2, 0, array(array($IcePHP__t_int, false, 0)), array(array($Murmur__t_ACLList, false, 0), array($Murmur__t_GroupList, false, 0), array($IcePHP__t_bool, false, 0)), null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'setACL', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($Murmur__t_ACLList, false, 0), array($Murmur__t_GroupList, false, 0), array($IcePHP__t_bool, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'addUserToGroup', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSessionException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'removeUserFromGroup', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidChannelException, $Murmur__t_InvalidSessionException, $Murmur__t_InvalidSecretException));
    IcePHP_defineOperation($Murmur__t_Server, 'redirectWhisperGroup', 2, 2, 0, array(array($IcePHP__t_int, false, 0), array($IcePHP__t_string, false, 0), array($IcePHP__t_string, false, 0)), null, null, array($Murmur__t_ServerBootedException, $Murmur__t_InvalidSessionException, $Murmur__t_InvalidSecretException));
...
{
    interface Murmur_MetaCallback extends Ice_Object
    {
...
{
    interface Murmur_Meta extends Ice_Object
    {
