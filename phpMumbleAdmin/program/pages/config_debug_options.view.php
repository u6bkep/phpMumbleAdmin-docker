...
<form method="post" onSubmit="return isFormModified(this);">
    ...
    <table class="config">
        ...
        <tr>
            ...
            <td>
                <input type="radio" name="mode" id="0" value="0" <?= HTML::chked($page->debug === 0); ?> />
                <label for="0">Level 0</label><br />
                <input type="radio" name="mode" id="1" value="1" <?= HTML::chked($page->debug === 1); ?> />
                <label for="1">Level 1</label><br />
                <input type="radio" name="mode" id="2" value="2" <?= HTML::chked($page->debug === 2); ?> />
                <label for="2">Level 2</label><br />
                <input type="radio" name="mode" id="3" value="3" <?= HTML::chked($page->debug === 3); ?> />
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" <?= $page->chked('langFlag'); ?> id="flag" name="flag" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" <?= $page->chked('debugStats'); ?> id="stats" name="stats" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" <?= $page->chked('debugMessages'); ?> id="messages" name="messages" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" <?= $page->chked('debugSession'); ?> id="session" name="session" />
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="checkbox" <?= $page->chked('pmaObject'); ?> id="object" name="object" />
            </td>
        </tr>
