...
$widget = $PMA->popups->getDatas('serverDelete'); ?>

<form id="serverDelete" method="POST" class="actionBox alert small">

    <input type="hidden" name="cmd" value="overview" />
    <input type="hidden" name="delete_vserver_id" value="<?= $widget->sid; ?>" />
