...
namespace Murmur
{
    if(!defined('\\Murmur\\ResetUserContent'))
    {
...
namespace Murmur
{
    ...
    $Murmur__t_UserInfo = IcePHP_defineEnum('::Murmur::UserInfo', array('UserName', 0, 'UserEmail', 1, 'UserComment', 2, 'UserHash', 3, 'UserPassword', 4, 'UserLastActive', 5, 'UserKDFIterations', 6));
}
...
namespace Murmur
{
    ...
    IcePHP_defineOperation($Murmur__t_ServerPrx, 'startListening', 2, 2, 0, array(array($IcePHP__t_int), array($IcePHP__t_int)), null, null, null);
    IcePHP_defineOperation($Murmur__t_ServerPrx, 'stopListening', 2, 2, 0, array(array($IcePHP__t_int), array($IcePHP__t_int)), null, null, null);
    IcePHP_defineOperation($Murmur__t_ServerPrx, 'isListening', 2, 2, 0, array(array($IcePHP__t_int), array($IcePHP__t_int)), null, array($IcePHP__t_bool), null);
    IcePHP_defineOperation($Murmur__t_ServerPrx, 'getListeningChannels', 2, 2, 0, array(array($IcePHP__t_int)), null, array($Murmur__t_IntList), null);
    IcePHP_defineOperation($Murmur__t_ServerPrx, 'getListeningUsers', 2, 2, 0, array(array($IcePHP__t_int)), null, array($Murmur__t_IntList), null);
    IcePHP_defineOperation($Murmur__t_ServerPrx, 'sendWelcomeMessage', 2, 2, 0, array(array($Murmur__t_IdList)), null, null, null);
}
